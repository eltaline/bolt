...
Eltaline Bolt is a merged fork of <a href=https://github.com/glycerine/bigbolt>bigbolt</a> + <a href=https://github.com/etcd-io/bbolt>bbolt</a>.

 - Supports database compaction and thus can store big values (over 1MB) from bigbolt.
...
infinite file growth. Big Bolt provides a Compact() api
...
To start using Eltaline Bolt, install Go and run `go get`:

```sh
$ go get github.com/eltaline/bolt
```
